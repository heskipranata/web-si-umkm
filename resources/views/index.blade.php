...
<section id="tentang" class="py-32 bg-green-500">
    <div class="container mx-auto flex flex-col md:flex-row items-stretch px-6 md:px-12 gap-12">
        ...
        <div class="md:w-1/2 h-full">
            <img src="https://res.cloudinary.com/dewi8c1ll/image/upload/v1747974707/bg2_ofaxma.jpg"
                alt="Tentang Cabadas jo" class="rounded-lg shadow-lg object-cover w-full h-full max-h-[400px]" />
        </div>
        ...
        <div class="md:w-1/2 flex flex-col justify-center">
            ...
            <p class="text-gray-100 text-xl mb-6 leading-relaxed">
                Terletak di jantung <span class="font-semibold text-green-800">kota Manado</span>, Cabadas jo hadir
                sebagai
